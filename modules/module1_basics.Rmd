...
7+runif(1) # add a random variable
4^4 # powers
sqrt(4^4) # functions
23 %/% 2 
23 %% 2
...
class(sum)
```
* We can embed function calls: `hist(rnorm(1000))`
...
The magic of OOP here is that methods (functions) can be tailored to work specifically with specific kinds of objects.
