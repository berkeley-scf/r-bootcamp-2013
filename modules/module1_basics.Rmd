...
- Put your code in a file and use `source()`: `source('myRcodeFile.R')`
...
Lists can be used as vectors of complicated objects. E.g., suppose you have a linear regression for each value of a stratifying variable. You could have a list of regression fits.
...
2) Take a random subset of 100 individuals from the earnings dataset and create a new data frame from it.
