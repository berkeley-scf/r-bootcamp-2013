...
For each combination of sex and education level, find the *second* largest value of earnings amongst the people in the group, in a clean format using tools such `sapply()`, `aggregate()`, or `by()`. Do not do this by looping. 
