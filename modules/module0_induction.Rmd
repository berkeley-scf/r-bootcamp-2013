...
The bootcamp will be organized in modules, each of which will be a combination of lecture/demo presentation with brief pauses for you to try out and experiment with code snippets, concluded by a longer problem or two for you to work at on your own in a breakout session. Solutions will be presented before the start of the next module. Assistants will be available to help answer any questions you have (just wave to one of them), or feel free to just ask during the presentation. We'll also have assistants monitoring the [bSpace chat room](https://bspace.berkeley.edu/portal/site/28905ed6-df96-4778-b2a7-d87fb6405ba2/page/f99ad10a-a841-4345-926d-c419b1a02913), so feel free to type in a question there and one of the counseloRs will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Jacob, Laura, Chris K., Jarrod, Tessa, Fu, Chao, Marla, and Christine.

I encourage you to:
- try out the code as I walk through it
- I'll illustrate a lot of syntax and concepts by example; keep your eyes open!
...
- ask questions of me, the helpers, and on Piazza/chat room
...
Username:	guest-181500
Password:	gXbxexOly4

Username:	guest-181501
Password:	UPZMRTr5u5

Username:	guest-181502
Password:	DCHCaq3ehO

Username:	guest-181503
Password:	Mvn1FrnsXz

Username:	guest-181504
Password:	gkMj6jLG4m

Username:	guest-181505
Password:	7i9fuiiyYN

Username:	guest-181506
Password:	Z0WHEruUWZ

Username:	guest-181507
Password:	m12GkCsrqc
...
RStudio provides an integrated development environment in which all of these pieces are in a single application and tightly integrated, with a built-in editor. 
